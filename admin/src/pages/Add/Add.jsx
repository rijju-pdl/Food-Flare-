    ...
    <div className='add'>
        <form  className="flex-col" onSubmit={onSubmitHandler}>
            ...
            <div className="add-product-restaurant flex-col">
                <p>Restaurant</p>
                <input onChange={onChangeHandler} value={data.restaurant} name="restaurant" rows='1' placeholder='Restaurant' required></input>
              </div>
              <div className="add-product-location flex-col">
                <p>Location</p>
                <input onChange={onChangeHandler} value={data.location} name="location" rows='1' placeholder='Location' required></input>
            </div>
